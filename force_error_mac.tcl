...
add_force {/tb/mac_triplex_duplex/mac_out[21]} -radix hex {0 560ns}
add_force {/tb/mac_triplex_duplex/mac_out[32]} -radix hex {0 580ns}
add_force {/tb/mac_triplex_duplex/mac_out[63]} -radix hex {0 600ns}
add_force {/tb/mac_triplex_duplex/mac_out[55]} -radix hex {0 620ns}
add_force {/tb/mac_triplex_duplex/mac_out[91]} -radix hex {0 640ns}
add_force {/tb/mac_triplex_duplex/mac_out[99]} -radix hex {0 660ns}
...
add_force {/tb/mac_triplex_duplex/mac_out[108]} -radix hex {0 760ns}
...
add_force {/tb/mac_triplex_duplex/mac_out[109]} -radix hex {123 860ns}
...
add_force {/tb/mac_triplex_duplex/mac_out[110]} -radix hex {554 1000ns}
