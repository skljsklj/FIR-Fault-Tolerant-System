...
add_force {/tb/mac_triplex_duplex/data_o_pair[90]} -radix hex {4221 600ns}
add_force {/tb/mac_triplex_duplex/data_o_pair[91]} -radix hex {5433 800ns}
add_force {/tb/mac_triplex_duplex/data_o_pair[92]} -radix hex {4534 1000ns}
add_force {/tb/mac_triplex_duplex/data_o_pair[93]} -radix hex {7381 1150ns}
